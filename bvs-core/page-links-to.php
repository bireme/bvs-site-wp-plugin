<?php
/*
Plugin Name: VHL Page Links To
Description: Modificaton of 'Page Links To' plugin that allow point VHL collection item to a URL 
Version: 2.4.1
Author: BIREME based on Mark Jaquith Page Links To Plugin
